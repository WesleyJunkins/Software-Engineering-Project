...
public class OperatorMenu() {
	...
	public void listActions() {
		...
		while (!quit) {
			...
			//print actions
			System.out.prinltn("\t1. Add Record\n\t2. Edit Record\n\t3. Delete Record\n\t4. Log Out");
			int decision = 0
			...
			while (1) {
				...
				if (decision > 0 && decision < 5)
					break;
				System.out.prinltn("Invalid Input. Please enter a number between 1 and 4.");
			}
			...
			case 4:
				...
				break;
			default:
				System.out.prinltn("No action could be performed. Try again.");
				break;
			}
		}
	}
	...
	public void editRecord() {
		...
		while (!done) {
			...
			case 3:
				...
				//pass to correct methods
				if (type == 1)
					controller.updateMemberPhoneNum(num);
				else
					controller.updateProviderPhoneNum(num);
			...
			//ask for other edits
			System.out.println("Would you like to make any more edits? y/n");
			while (1) {
				char quit = scan.nextChar();
				if (!(quit == 'n' || quit == 'y'))
