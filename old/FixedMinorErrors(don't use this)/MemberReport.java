...
public class MemberReport {
    ...
    public String generateReport() {
        ...
        report.append("Address: ").append(member.getFullAddress()).append("\n");
        report.append("City: ").append(member.getCity()).append("\n");
        report.append("State: ").append(member.getState()).append("\n");
        report.append("ZIP Code: ").append(member.getZipCode()).append("\n");

        // Add the member's provider information to the string
        report.append("Provider Name: ").append(member.getName()).append("\n");
        report.append("Provider Number: ").append(member.getNumber()).append("\n");
